...
namespace MVC_Viper.Controllers
{
    public class SellersController : Controller
    {
        ...
        public SellersController(ProviderDBContext context)
        {
            _context = context;
        }
        ...
        {
            var providerDBContext = _context.Sellers.Include(s => s.User);
        ...
        public async Task<IActionResult> Welcome()
        {
            ...
            var seller = await _context.Sellers.Include(s => s.User).FirstOrDefaultAsync(s => s.User.Username == username);
            ...
            ViewBag.Clients = await _context.Clients.Include(c => c.User).ToListAsync();
